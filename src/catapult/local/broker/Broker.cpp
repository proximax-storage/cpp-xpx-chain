		...
		public:
			void boot() {
				...
				if(isFirstBoot) {
					...
					io::FileBlockStorage storage(m_dataDirectory.rootDir().str(), m_pBootstrapper->configHolder()->Config().Immutable.NemesisHeight, io::FileBlockStorageMode::Hash_Index);
