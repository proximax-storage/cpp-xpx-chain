...
//				m_pBlockChainStorage->saveToStorage(stateCref());
		...
		private:
			...
			void registerCounters() {
				...
				m_pluginManager.addDiagnosticCounters(m_counters, m_state.Cache); // add cache counters
