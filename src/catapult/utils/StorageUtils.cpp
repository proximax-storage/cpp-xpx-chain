...
namespace catapult { namespace utils {
	Hash256 getEventHash(const Hash256& blockHash, const catapult::GenerationHash& generationHash, const std::string& salt) {
		Hash256 eventHash;
		crypto::Sha3_256_Builder sha3;
		sha3.update({blockHash,
