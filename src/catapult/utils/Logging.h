...
#define CATAPULT_DESTRUCTOR_CLEANUP_LOG(SEV, DESTRUCTOR, TEXT) \
	~DESTRUCTOR() { \
		CATAPULT_CLEANUP_LOG(SEV, TEXT); \
	}
#define DECLARE_CATAPULT_DESTRUCTOR_DEFINITION_CLEANUP_LOG(DESTRUCTOR) \
	~DESTRUCTOR();

#define DEFINE_CATAPULT_CLEANUP_LOG_FOUR_DEFAULTS(DESTRUCTOR) \
	DESTRUCTOR(const DESTRUCTOR& keyPair) = default; \
	DESTRUCTOR(DESTRUCTOR&& DESTRUCTOR) = default; \
	DESTRUCTOR& operator=(const DESTRUCTOR& other) = default; \
	DESTRUCTOR& operator=(DESTRUCTOR&& other) = default;

#define DEFINE_CATAPULT_DESTRUCTOR_DEFINITION_CLEANUP_LOG(SEV, DESTRUCTOR, TEXT) \
	DESTRUCTOR::~DESTRUCTOR() { CATAPULT_CLEANUP_LOG(SEV, TEXT); }
#else
#define CATAPULT_DESTRUCTOR_CLEANUP_LOG(SEV, DESTRUCTOR, TEXT) ;
#define CATAPULT_CLEANUP_LOG(SEV, TEXT) ;
#define DECLARE_CATAPULT_DESTRUCTOR_DEFINITION_CLEANUP_LOG(DESTRUCTOR) ;
