...
#define CATAPULT_CLEANUP_THROTTLE_LOG(SEV, THROTTLE_MILLIS, TEXT) \
	CATAPULT_LOG_THROTTLE(SEV, THROTTLE_MILLIS) << TEXT
#else
#define CATAPULT_CLEANUP_THROTTLE_LOG(SEV, THROTTLE_MILLIS, TEXT) ;
#endif

#ifdef CLEANUP_LOGGING_ENABLED
#define DEFINE_CATAPULT_DESTRUCTOR_THROTTLE_CLEANUP_LOG(SEV, THROTTLE_MILLIS, DESTRUCTOR, TEXT) \
	DESTRUCTOR::~DESTRUCTOR() { CATAPULT_CLEANUP_THROTTLE_LOG(SEV, THROTTLE_MILLIS, TEXT); }
#else
#define DEFINE_CATAPULT_DESTRUCTOR_THROTTLE_CLEANUP_LOG(SEV, THROTTLE_MILLIS, DESTRUCTOR, TEXT) ;
#endif