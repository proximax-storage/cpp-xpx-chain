...
//		// Assert:
//		auto height = Height(10000);
//		AssertValidationResult(Failure_Core_Block_Harvester_Ineligible, 12345, height);
//	}
//
//	TEST(TEST_CLASS, FailureIfImportanceIsNotSetAtCorrectHeight) {
//		// Assert:
//		AssertValidationResult(Failure_Core_Block_Harvester_Ineligible, 12345, Height(1234));
//	}
//
