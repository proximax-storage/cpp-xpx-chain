...
namespace catapult { namespace validators {
	...
	DECLARE_STATEFUL_VALIDATOR(DriveFilesReward, model::DriveFilesRewardNotification<1>)(const std::shared_ptr<config::BlockchainConfigurationHolder>& pConfigHolder);
