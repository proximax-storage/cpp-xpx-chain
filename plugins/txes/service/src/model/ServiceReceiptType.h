...
namespace catapult { namespace model {
	...
	DEFINE_RECEIPT_TYPE(Drive, Drive, Drive_Download_Started, 6);

	DEFINE_RECEIPT_TYPE(Drive, Drive, Drive_Download_Completed, 7);

	DEFINE_RECEIPT_TYPE(Drive, Drive, Drive_Download_Expired, 8);
