...
#pragma pack(push, 1)
	...
	struct ImmutableMetadataTransactionHeader : public THeader {
	...
	/// Binary layout for a basic immutable metadata transaction body.
	template<typename THeader, EntityType Immutable_Metadata_Entity_Type>
	struct BasicImmutableMetadataTransactionBody : public THeader {
	private:
		using TransactionType = BasicImmutableMetadataTransactionBody<THeader, Immutable_Metadata_Entity_Type>;

	public:
		DEFINE_TRANSACTION_CONSTANTS(Immutable_Metadata_Entity_Type, 1)
