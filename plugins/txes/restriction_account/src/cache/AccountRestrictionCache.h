...
namespace catapult { namespace cache {
	...
	public:
		...
		AccountRestrictionCache(const CacheConfiguration& config, std::shared_ptr<config::BlockchainConfigurationHolder> pConfigHolder)
				: SynchronizedCache<BasicAccountRestrictionCache>(BasicAccountRestrictionCache(config, std::move(pConfigHolder)))
		{}
	};
}}
