...
namespace catapult { namespace config {
	...
	namespace {
		struct CatapultConfigConfigurationTraits {
			using ConfigurationType = CatapultConfigConfiguration;
			...
			static void AssertZero(const CatapultConfigConfiguration& config) {
				// Assert:
			...
			static void AssertCustom(const CatapultConfigConfiguration& config) {
				// Assert:
	...
	DEFINE_CONFIGURATION_TESTS(CatapultConfigConfigurationTests, CatapultConfig)
}}
