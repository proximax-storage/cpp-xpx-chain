...
#define TEST_CLASS ModifyMultisigAccountAndReputationTransactionPluginTests

	namespace {
		DEFINE_TRANSACTION_PLUGIN_TEST_TRAITS(ModifyMultisigAccountAndReputation)
	...
	DEFINE_BASIC_EMBEDDABLE_TRANSACTION_PLUGIN_TESTS(TEST_CLASS, Entity_Type_Modify_Multisig_Account_And_Reputation)
