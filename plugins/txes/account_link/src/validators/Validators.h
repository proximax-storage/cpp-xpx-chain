...
namespace catapult { namespace validators {
	...
	DECLARE_STATEFUL_VALIDATOR(AccountLinkAvailability, model::RemoteAccountLinkNotification<1>)();
	...
	DECLARE_STATEFUL_VALIDATOR(NewRemoteAccountAvailabilityV2, model::NewRemoteAccountNotification<2>)();
	...
	DECLARE_STATEFUL_VALIDATOR(RemoteSender, model::TransactionNotification<1>)();
