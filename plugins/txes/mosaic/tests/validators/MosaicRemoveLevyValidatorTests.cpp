...
#define TEST_CLASS MosaicRemoveLevyValidatorTests
        ...
        TEST(TEST_CLASS, IneligibleSigner) {
            ...
            AssertValidationResult(Failure_Mosaic_Ineligible_Signer, Currency_Mosaic_Id, signer, cache, config);
        }
        ...
        TEST(TEST_CLASS, MosaicLevyNotFound) {
            ...
            AssertValidationResult(Failure_Mosaic_Levy_Entry_Not_Found, Currency_Mosaic_Id, signer, cache, config);
        }
        ...
        TEST(TEST_CLASS, MosaicIdNotFound) {
            ...
            auto cache = test::LevyCacheFactory::Create(config);
            auto signer = test::GenerateRandomByteArray<Key>();
            AssertValidationResult(Failure_Mosaic_Id_Not_Found, Currency_Mosaic_Id, signer, cache, config);
        }

        TEST(TEST_CLASS, RemoveLevyNotEnabled) {
            ...
            AssertValidationResult(Failure_Mosaic_Levy_Not_Enabled, Currency_Mosaic_Id, signer, cache, config);
        }
