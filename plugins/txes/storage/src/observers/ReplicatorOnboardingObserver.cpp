...
namespace catapult { namespace observers {
	...
	namespace {
		...
		void ReplicatorOnboardingObserver(const model::ReplicatorOnboardingNotification<version>& notification, const ObserverContext& context) {
	...
	DECLARE_OBSERVER(ReplicatorOnboardingV1, model::ReplicatorOnboardingNotification<1>)() {
		return MAKE_OBSERVER(ReplicatorOnboardingV1, model::ReplicatorOnboardingNotification<1>, ([](const model::ReplicatorOnboardingNotification<1>& notification, const ObserverContext& context) {
	...
	DECLARE_OBSERVER(ReplicatorOnboardingV2, model::ReplicatorOnboardingNotification<2>)() {
		return MAKE_OBSERVER(ReplicatorOnboardingV2, model::ReplicatorOnboardingNotification<2>, ([](const model::ReplicatorOnboardingNotification<2>& notification, const ObserverContext& context) {
			ReplicatorOnboardingObserver(notification, context);
		}))
	}
}}
