...
namespace catapult { namespace cache {
	...
	class BasicDriveCacheView
			...
			, public DriveCacheViewMixins::ConfigBasedEnable<config::StorageConfiguration> {
	public:
	...
	public:
		...
		explicit BasicDriveCacheView(const DriveCacheTypes::BaseSets& driveSets, std::shared_ptr<config::BlockchainConfigurationHolder> pConfigHolder)
				...
				, DriveCacheViewMixins::ConfigBasedEnable<config::StorageConfiguration>(pConfigHolder, [](const auto& config) { return config.Enabled; })
		{}
	};
