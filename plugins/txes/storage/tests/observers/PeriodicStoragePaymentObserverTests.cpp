...
#define TEST_CLASS PeriodicStoragePaymentObserverTests
    ...
    DEFINE_COMMON_OBSERVER_TESTS(PeriodicStoragePayment, Liquidity_Provider, Updates_Listeners)
    ...
    namespace {
        ...
        void RunTest(NotifyMode mode, const CacheValues& values, const Height& currentHeight) {
            ...
            auto pObserver = CreatePeriodicStoragePaymentObserver(Liquidity_Provider, Updates_Listeners);
