...
#define DECLARE_SHARED_VALIDATORS(VALUE_NAME) \
	...
	/// A validator implementation that applies to levy transfer notifications and validates that:
	/// - the mosaic is allowed to be transferred to the recipient
	DECLARE_STATEFUL_VALIDATOR(LevyRecipient, model::LevyTransferNotification<1>)();
