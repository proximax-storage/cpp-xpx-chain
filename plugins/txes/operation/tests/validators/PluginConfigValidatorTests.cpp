...
#define TEST_CLASS PluginConfigValidatorTests
	...
	DEFINE_COMMON_VALIDATOR_TESTS(OperationPluginConfig,)

	namespace {
		struct PluginConfigTraits {
			static auto CreatePluginConfigValidator() {
				return validators::CreateOperationPluginConfigValidator();
			}
	...
	DEFINE_PLUGIN_CONFIG_VALIDATOR_TESTS(TEST_CLASS, PluginConfigTraits, 1, operation, Operation)
}}
