...
namespace catapult { namespace cache {
	...
	public:
		...
		MosaicRestrictionCache(const CacheConfiguration& config, std::shared_ptr<config::BlockchainConfigurationHolder> pConfigHolder)
				: SynchronizedCache<BasicMosaicRestrictionCache>(BasicMosaicRestrictionCache(config, std::move(pConfigHolder)))
		{}
	};
}}
