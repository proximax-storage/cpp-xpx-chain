...
#undef DEFINE_LOCKHASH_NOTIFICATION
	...
	public:
		...
		explicit HashLockMosaicNotification(UnresolvedMosaic mosaic, VersionType version)
				: Notification(Notification_Type, sizeof(HashLockMosaicNotification), version)
				, Mosaic(mosaic)
		{}
