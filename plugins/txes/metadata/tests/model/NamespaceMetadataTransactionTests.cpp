...
namespace catapult { namespace model {
        ...
        using TransactionType = NamespaceMetadataV1Transaction;

#define TEST_CLASS NamespaceMetadataV1TransactionTests
        ...
        ADD_BASIC_TRANSACTION_SIZE_PROPERTY_TESTS(NamespaceMetadataV1)
