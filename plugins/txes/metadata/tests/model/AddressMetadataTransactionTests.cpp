...
namespace catapult { namespace model {
    ...
    using TransactionType = AddressMetadataV1Transaction;

#define TEST_CLASS AddressMetadataV1TransactionTests
    ...
    namespace {
        ...
        void AssertEntityHasExpectedSize(size_t baseSize) {
            ...
            auto expectedSize = baseSize // base
                ...
                + sizeof(UnresolvedAddress); // MetadataId

            // Assert:
            EXPECT_EQ(expectedSize, sizeof(T));
            EXPECT_EQ(baseSize + 26u, sizeof(T));
        }
    ...
    ADD_BASIC_TRANSACTION_SIZE_PROPERTY_TESTS(AddressMetadataV1)
