...
#define TEST_CLASS ResumeObserverTests

	DEFINE_COMMON_OBSERVER_TESTS(Resume, )
	...
	TEST(TEST_CLASS, Resume_Commit) {
		...
		auto pObserver = CreateResumeObserver();
	...
	TEST(TEST_CLASS, Resume_Rollback) {
		// Arrange:
