...
namespace catapult { namespace builders {
	...
	model::UniqueEntityPtr<MosaicAddressRestrictionBuilder::Transaction> MosaicAddressRestrictionBuilder::build() const {
		return buildImpl<Transaction>();
	}

	model::UniqueEntityPtr<MosaicAddressRestrictionBuilder::EmbeddedTransaction> MosaicAddressRestrictionBuilder::buildEmbedded() const {
	...
	template<typename TransactionType>
	model::UniqueEntityPtr<TransactionType> MosaicAddressRestrictionBuilder::buildImpl() const {
