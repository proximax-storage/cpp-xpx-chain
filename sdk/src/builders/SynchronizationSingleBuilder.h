...
namespace catapult { namespace builders {
	...
	class SynchronizationSingleBuilder : public TransactionBuilder {
	public:
		using Transaction = model::SynchronizationSingleTransaction;
		using EmbeddedTransaction = model::EmbeddedSynchronizationSingleTransaction;

		/// Creates a catapult upgrade builder for building a catapult upgrade transaction from \a signer
		/// for the network specified by \a networkIdentifier.
		SynchronizationSingleBuilder(model::NetworkIdentifier networkIdentifier, const Key& signer);
