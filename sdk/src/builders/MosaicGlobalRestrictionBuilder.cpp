...
namespace catapult { namespace builders {
	...
	model::UniqueEntityPtr<MosaicGlobalRestrictionBuilder::Transaction> MosaicGlobalRestrictionBuilder::build() const {
		return buildImpl<Transaction>();
	}

	model::UniqueEntityPtr<MosaicGlobalRestrictionBuilder::EmbeddedTransaction> MosaicGlobalRestrictionBuilder::buildEmbedded() const {
	...
	template<typename TransactionType>
	model::UniqueEntityPtr<TransactionType> MosaicGlobalRestrictionBuilder::buildImpl() const {
