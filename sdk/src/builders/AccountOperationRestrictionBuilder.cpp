...
namespace catapult { namespace builders {
	...
	model::UniqueEntityPtr<AccountOperationRestrictionBuilder::Transaction> AccountOperationRestrictionBuilder::build() const {
		return buildImpl<Transaction>();
	}

	model::UniqueEntityPtr<AccountOperationRestrictionBuilder::EmbeddedTransaction> AccountOperationRestrictionBuilder::buildEmbedded() const {
	...
	template<typename TransactionType>
	model::UniqueEntityPtr<TransactionType> AccountOperationRestrictionBuilder::buildImpl() const {
