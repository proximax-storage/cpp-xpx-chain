...
namespace catapult { namespace builders {
	...
	model::UniqueEntityPtr<AccountMosaicRestrictionBuilder::Transaction> AccountMosaicRestrictionBuilder::build() const {
		return buildImpl<Transaction>();
	}

	model::UniqueEntityPtr<AccountMosaicRestrictionBuilder::EmbeddedTransaction> AccountMosaicRestrictionBuilder::buildEmbedded() const {
	...
	template<typename TransactionType>
	model::UniqueEntityPtr<TransactionType> AccountMosaicRestrictionBuilder::buildImpl() const {
