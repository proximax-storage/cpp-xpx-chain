...
namespace catapult { namespace builders {
	...
	model::UniqueEntityPtr<AccountAddressRestrictionBuilder::Transaction> AccountAddressRestrictionBuilder::build() const {
		return buildImpl<Transaction>();
	}

	model::UniqueEntityPtr<AccountAddressRestrictionBuilder::EmbeddedTransaction> AccountAddressRestrictionBuilder::buildEmbedded() const {
	...
	template<typename TransactionType>
	model::UniqueEntityPtr<TransactionType> AccountAddressRestrictionBuilder::buildImpl() const {
