...
load('mongoSdaExchangeDbPrepare.js')
...
load('mongoCommitteeDbPrepare.js')
load('mongoStorageDbPrepare.js')
load('mongoDbrbDbPrepare.js')
load('mongoSupercontractDbPrepare.js')