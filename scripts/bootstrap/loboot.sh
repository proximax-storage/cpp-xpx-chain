PATH_TO_CATAPULT_SERVER="/home/ruell/proximax/tasks/PC-263/cpp-xpx-chain"
PATH_TO_BOOTSTRAP="/home/ruell/proximax/tasks/PC-263/cpp-xpx-chain/scripts/bootstrap"
...
copy_nemesis_block_from ()
{
	echo "Copying Nemesis block from $WORK_DIR/data/$1/data/ to $WORK_DIR/data/$2/data/"
	cp -rfa $WORK_DIR/data/$1/data/* $WORK_DIR/data/$2/data/
}
...
generate_nem_norun "api-node-0"
generate_nem_norun "peer-node-0"
generate_nem_norun "peer-node-1"
#generate_nem_norun "peer-node-2"
#generate_nem_norun "peer-node-3"
#generate_nem_norun "peer-node-4"

copy_nemesis_block_from "api-node-0" "peer-node-0"
copy_nemesis_block_from "api-node-0" "peer-node-1"
#copy_nemesis_block_from "api-node-0" "peer-node-2"
#copy_nemesis_block_from "api-node-0" "peer-node-3"
#copy_nemesis_block_from "api-node-0" "peer-node-4"
