...
//		struct TestContext {
//			TestContext()
//					: TestContext({}, {}, test::GenerateVerifiableBlockAtHeight(Default_Height))
//			{}
//
//			TestContext(std::unique_ptr<Block>&& pRemoteLastBlock)
//					: TestContext({}, {}, std::move(pRemoteLastBlock))
//			{}
//
//			TestContext(
...
//					, pChainApi(std::make_shared<MockChainApi>(std::move(pRemoteLastBlock), remoteHashes))
...
//			auto pLocal = std::make_shared<MockChainApi>(std::move(pVerifiableBlock), context.LocalHashes);
//
...
//		TestContext context(test::GenerateNonVerifiableBlockAtHeight(Default_Height));
//		auto synchronizer = CreateSynchronizer(context);
//
//		// Act:
//		auto result = synchronizer(*context.pChainApi).get();
...
//	namespace {
//
//		auto CreateTestContextForUnprocessedElementTests() {
