...
//			MockChainApi local(Height(4), localHashes);
//			MockChainApi remote(Height(4), remoteHashes);
...
//			// Arrange:
//			MockChainApi local(localHeight);
//			MockChainApi remote(remoteHeight);
...
//			// Arrange:
//			MockChainApi local(Height(numHashes));
//			MockChainApi remote(Height(numHashes), numHashes);
...
//		*----remoteHashes.end() = *----localHashes.cend();
//		MockChainApi local(Height(3), localHashes);
//		MockChainApi remote(Height(3), remoteHashes);
//
//		// Act:
...
//		auto commonHashes = test::GenerateRandomHashes(3);
//		MockChainApi local(Height(3), commonHashes);
//		MockChainApi remote(Height(3), commonHashes);
//
//		// Act:
//		auto result = CompareChains(local, remote, { 1000, 1000 }).get();
//
...
//		MockChainApi local(Height(3), localHashes);
//		MockChainApi remote(Height(2), remoteHashes);
//
//		// Act:
//		auto result = CompareChains(local, remote, { 1000, 1000 }).get();
//
...
//		MockChainApi local(Height(2), localHashes);
//		MockChainApi remote(Height(3), remoteHashes);
...
//		MockChainApi local(Height(8), localHashes);
//		MockChainApi remote(Height(13), remoteHashes);
//		remote.addBlock(test::GenerateVerifiableBlockAtHeight(Height(3)));
//
//		// Act:
//		auto result = CompareChains(local, remote, { 1000, 1000 }).get();
...
//			auto localHashes = test::ConcatHashes(commonHashes, test::GenerateRandomHashes(1));
//			auto remoteHashes = test::ConcatHashes(commonHashes, test::GenerateRandomHashes(1));
//			MockChainApi local(Height(20), localHashes);
//			MockChainApi remote(Height(20), remoteHashes);
//
//			// Act:
