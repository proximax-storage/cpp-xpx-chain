...
#define TEST_CLASS SignerTests
	...
	namespace {
		...
		TestVectorsInput GetTestVectorsInput() {
			...
			input.ExpectedPublicKeysSha2 = {
				"96A1D6CC5620E76E92A632DCB6B415A7E83809798D4D9E661E87FF0BE2A0D0C3",
				"9028A1FC1EE162203F9FD9E436B2F438681878C168223D5039869BF7304151D5",
				"66CFB5FE5112F7BDA929E06440D70412C9EADFDAD6C74804806BE3C0A10AB322",
				"8491FEDB3C435DC8871B9A17A378F1C5E359FE918568D596718CAC8A80F1BDC5",
				"53A45335FCB715A6F07EE5051828C5CAAAEC57E2B61A34A6F903D0B89339471F"
			};
			input.ExpectedSignaturesSha3 = {
				"01C9B1342EAB27E906567586803DA265CC15CCACA411E0AEF44508595ACBC47600D02527F2EED9AB3F28C856D27E30C3808AF7F22F5F243DE698182D373A9ADE03",
				"010755E437ED4C8DD66F1EC29F581F6906AB1E98704ECA94B428A25937DF00EC64796F08E5FEF30C6F6C57E4A5FB4C811D617FA661EB6958D55DAE66DDED205501",
				"0115D6585A2A456E90E89E8774E9D12FE01A6ACFE09936EE41271AA1FBE0551264A9FF9329CB6FEE6AE034238C8A91522A6258361D48C5E70A41C1F1C51F55330D",
				"01F6FB0D8448FEC0605CF74CFFCC7B7AE8D31D403BCA26F7BD21CB4AC87B00769E9CC7465A601ED28CDF08920C73C583E69D621BA2E45266B86B5FCF8165CBE309",
				"01E88D8C32FE165D34B775F70657B96D8229FFA9C783E61198A6F3CCB92F487982D08F8B16AB9157E2EFC3B78F126088F585E26055741A9F25127AC13E883C9A05"
			};
			input.ExpectedSignaturesSha2 = {
				"02B1E630A655B8A5A13C2443E7F594E6A367CD006009D4720DAC8B649A070369EFE8C537E019800291C2C3FAE1E36695466C7D0542FB8EF6E52EFEA98C1B2F0101",
				"02EA4268E8F2510641A4E549D38A04CDD244BBE0B55ECF430933A6710774B6DF112BE00CF88E0CFB9DCA25A0A0937F748407235077BBCA7917B8F09FE194AA1202",
				"02B0450D30F8D40FD9A4EC8DCC9F4829A3707978C59058D867BCAACE66329F385CC3D79323B545EF8D8560DB7E15B542C1A93CD4DAF9AD8D8055108F9CC9063102",
				"028C918E975C68B2F0FF9EAD40A0EFF22FC6C0BBCCBADB0421EFC3BC305D2EE6C7B3E2147435F4C94D81B82FE407BDA6B6FF02BD44601E0D8FD9E9E981362A830A",
				"024150925C4E4FA6743A46B6A10F7FB0A24877B9D8014F70C66B31B2618B6E80646FFAB1AA42E6F90C711224967B12E0E4FBF734FE36A52A90481B1136C533B203"
			};
	...
	TEST(TEST_CLASS, SignPassesTestVectors) {
		...
		for (auto i = 0u; i < input.InputData.size(); ++i) {
			...
			EXPECT_EQ(input.ExpectedSignaturesSha2[i], test::ToString(signatureSha2)) << message;
		}
	}
