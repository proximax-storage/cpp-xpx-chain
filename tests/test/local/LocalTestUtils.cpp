...
namespace catapult { namespace test {
	...
	namespace {
		...
		constexpr auto supportedVersions =
			...
			"\t\t},\n"
			"\t\t{\n"
			"\t\t\t\"name\": \"Aggregate_Complete_V1\",\n"
			"\t\t\t\"type\": \"16705\",\n"
			"\t\t\t\"supportedVersions\": [2, 3]\n"
			"\t\t},\n"
			"\t\t{\n"
			"\t\t\t\"name\": \"Aggregate_Bonded_V1\",\n"
			"\t\t\t\"type\": \"16961\",\n"
			"\t\t\t\"supportedVersions\": [2, 3]\n"
			"\t\t},\n"
			"\t\t{\n"
			"\t\t\t\"name\": \"Aggregate_Complete_V2\",\n"
			"\t\t\t\"type\": \"17217\",\n"
			"\t\t\t\"supportedVersions\": [1]\n"
			"\t\t},\n"
			"\t\t{\n"
			"\t\t\t\"name\": \"Aggregate_Bonded_V2\",\n"
			"\t\t\t\"type\": \"17473\",\n"
			"\t\t\t\"supportedVersions\": [1]\n"
			"\t\t},\n"
			"\t\t{\n"
	...
	namespace {
		std::shared_ptr<plugins::PluginManager> CreatePluginManager(
			...
			std::shared_ptr<config::BlockchainConfigurationHolder> pConfigHolder = std::make_shared<config::TestBlockchainConfigurationHolder>(config);
			...
			pPluginManager->configHolder()->SetPluginInitializer(initializers);
