...
#define DEFINE_ATTACHMENT_ACCESS_TESTS(TEST_CLASS, TEST_TRAITS, TEST_NAME) \
	TEST(TEST_CLASS, TEST_NAME##TEST_TRAITS##_Const) { test::Assert##TEST_NAME<TEST_TRAITS, test::ConstAccessor>(); } \
	TEST(TEST_CLASS, TEST_NAME##TEST_TRAITS##_NonConst) { test::Assert##TEST_NAME<TEST_TRAITS, test::NonConstAccessor>(); } \
