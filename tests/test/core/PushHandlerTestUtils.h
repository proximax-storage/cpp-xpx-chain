...
#define MAKE_PUSH_HANDLER_TEMPLATED_TEST(TEST_CLASS, TEST_SUFFIX, HANDLER_NAME, TEMPLATE_NAME, TEST_NAME) \
	TEST(TEST_CLASS, HANDLER_NAME##_##TEST_NAME##_##TEST_SUFFIX) { test::PushHandlerTests<HANDLER_NAME##Traits<TEMPLATE_NAME>>::Assert##TEST_NAME(); }

#define DEFINE_PUSH_HANDLER_TEMPLATED_TESTS(TEST_CLASS, TEST_SUFFIX, HANDLER_NAME, TEMPLATE_NAME) \
	MAKE_PUSH_HANDLER_TEMPLATED_TEST(TEST_CLASS, TEST_SUFFIX, HANDLER_NAME, TEMPLATE_NAME, MalformedPacketIsRejected) \
	MAKE_PUSH_HANDLER_TEMPLATED_TEST(TEST_CLASS, TEST_SUFFIX, HANDLER_NAME, TEMPLATE_NAME, ValidPacketWithValidTransactionsIsAccepted)
}}
