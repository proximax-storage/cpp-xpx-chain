...
namespace catapult { namespace filechain {
	...
	/// Save catapult \a cache state along with \a supplementalData and blockchain configurations from \a pConfigHolder
	/// into state directory inside \a dataDirectory.
	...
	/// Load catapult \a cache state, \a supplementalData and blockchain configurations (into \a pConfigHolder)
	/// from state directory inside \a dataDirectory.
