...
#define ACTION(NAME) [] (WeightedVotingActions& actions) { actions.NAME(); }
			...
			return sml::make_transition_table(
				...
				*sml::state<StopWaiting> + sml::unexpected_event<sml::_> = sml::X,
				...
				sml::state<CommitteeSelection> + sml::event<CommitteeSelectionResult> [ isNotPhasePropose ] = sml::state<ConfirmedBlockWaiting>,

				sml::state<BlockProposing> + sml::on_entry<sml::_> / ACTION(ProposeBlock),
				sml::state<BlockProposing> + sml::event<BlockProposingFailed> = sml::state<ConfirmedBlockWaiting>,
