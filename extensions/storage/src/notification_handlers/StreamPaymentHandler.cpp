...
namespace catapult { namespace notification_handlers {
	...
	DECLARE_HANDLER(StreamPayment, Notification)(const std::weak_ptr<storage::ReplicatorService>& pReplicatorServiceWeak) {
		return MAKE_HANDLER(StreamPayment, [pReplicatorServiceWeak](const Notification& notification, const HandlerContext& context) {
