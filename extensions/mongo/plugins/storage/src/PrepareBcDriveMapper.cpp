...
#include "plugins/txes/storage/src/model/PrepareBcDriveTransaction.h"
...
namespace catapult { namespace mongo { namespace plugins {
	...
	DEFINE_MONGO_TRANSACTION_PLUGIN_FACTORY(PrepareBcDrive, StreamPrepareBcDriveTransaction)
}}}
