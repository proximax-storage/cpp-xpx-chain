...
#include "plugins/txes/storage/src/model/DownloadPaymentTransaction.h"
...
namespace catapult { namespace mongo { namespace plugins {
	...
	DEFINE_MONGO_TRANSACTION_PLUGIN_FACTORY(DownloadPayment, StreamDownloadPaymentTransaction)
}}}
