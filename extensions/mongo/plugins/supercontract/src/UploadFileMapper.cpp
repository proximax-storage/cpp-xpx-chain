...
namespace catapult { namespace mongo { namespace plugins {
	...
	void StreamUploadFileTransaction(bson_stream::document& builder, const TTransaction& transaction) {
	...
	DEFINE_MONGO_TRANSACTION_PLUGIN_FACTORY(UploadFile, StreamUploadFileTransaction)
}}}
