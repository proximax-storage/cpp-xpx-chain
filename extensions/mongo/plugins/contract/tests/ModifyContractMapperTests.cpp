...
//			auto pBuilder = CreateModifyContractTransactionBuilder(signer, modifications);
...
//
//	PLUGIN_TEST(CanMapModifyContractTransactionWithoutModification) {
//		// Assert:
//		AssertCanMapModifyContractTransaction<TTraits>({});
//	}
//
//	PLUGIN_TEST(CanMapModifyContractTransactionWithSingleModification) {
//		// Assert:
//		AssertCanMapModifyContractTransaction<TTraits>({ { ModificationType::Add, test::GenerateRandomData<Key_Size>() } });
//	}
//
//	PLUGIN_TEST(CanMapModifyContractTransactionWithMultipleModification) {
//		// Assert:
//		AssertCanMapModifyContractTransaction<TTraits>({
